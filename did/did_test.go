...
func TestDecodeDID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			did, err := DecodeERC721DID(tt.input)
...
func TestDecodeERC721orNFTDID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			did, err := DecodeERC721orNFTDID(tt.input)
...
func TestDecodeEthrDID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			did, err := DecodeEthrDID(tt.input)
...
func TestDecodeERC20DID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			did, err := DecodeERC20DID(tt.input)
